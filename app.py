...
class Profile(db.Model):
    #Each prospective student has a profile 
    id = db.Column(db.Integer, primary_key=True)
    undergrad_uni = db.Column(db.String(20),unique=True,nullable=False)
    undergrad_completion = db.Column(db.String(20),unique=True,nullable=False)
    email = db.Column(db.String(120),unique=True,nullable=False)
    image_file = db.Column(db.String(20),nullable=False,default='default.jpg')
    password = db.Column(db.String(60),nullable=False)
...
def generateEmails():
    ...
    if request.method == 'POST':
        ...
        print(query)
	#text = test["choices"][0]["text"]
        prompt = 'Write an Email aboout: '.format(query)
